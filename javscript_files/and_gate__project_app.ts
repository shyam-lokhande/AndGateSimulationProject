...
var and_gate:Geometry.AndGate=new Geometry.AndGate(new Geometry.Point(400,300),15,context);
...
//Texts
var IgnitionText: Geometry.Text = new Geometry.Text("Ignition ON",240,220);
var WiperText: Geometry.Text = new Geometry.Text("Wiper ON",240,320);
var FirstInputText: Geometry.Text = new Geometry.Text("OFF",283,257);
var SecondInputText: Geometry.Text = new Geometry.Text("OFF",283,357);
...
var first_input:string="off";
var second_input:string="off";
function redraw(){
    connect1.draw();                                                                
    connect2.draw();
    connect3.draw();
